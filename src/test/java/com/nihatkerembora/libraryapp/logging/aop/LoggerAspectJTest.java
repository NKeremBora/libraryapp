package com.nihatkerembora.libraryapp.logging.aop;
...
import com.nihatkerembora.libraryapp.logging.service.LogService;
...
class LoggerAspectJTest extends AbstractBaseServiceTest {
    ...
    public void testGetHttpStatusFromException_AllCases() {
        ...
        testCases.put(new UserNotActiveException("User is not active"), UserNotActiveException.STATUS.name());
        testCases.put(new BookNotAvailableException("Book is not available"), BookNotAvailableException.STATUS.name());
        testCases.put(new BorrowingNotFoundException("Borrowing not found"), BorrowingNotFoundException.STATUS.name());
        testCases.put(new AlreadyReturnedException("Book already returned"), AlreadyReturnedException.STATUS.name());
        testCases.put(new UnAuthorizeAttemptException(), UnAuthorizeAttemptException.STATUS.name());
