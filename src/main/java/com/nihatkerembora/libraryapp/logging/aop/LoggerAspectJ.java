...
public class LoggerAspectJ {
    ...
    private String getHttpStatusFromException(Exception ex) {
        return switch (ex.getClass().getSimpleName()) {
            ...
            case "UserNotActiveException" -> UserNotActiveException.STATUS.name();
            case "BookNotAvailableException" -> BookNotAvailableException.STATUS.name();
            case "BorrowingNotFoundException" -> BorrowingNotFoundException.STATUS.name();
            case "AlreadyReturnedException" -> AlreadyReturnedException.STATUS.name();
            case "UnAuthorizeAttemptException" -> UnAuthorizeAttemptException.STATUS.name();
